 ...
 * @returns {number} Estimate Delivery Date .
 */
...
try {
    ...
    function estimateDate(date, scale) {
        ...
        const findEstimateDate = new Date(day.setDate(day.getDate() + 280 + scaleMatch['value2'] - 1));
        const findWeek = new Date(day.setDate(day.getDate() - scaleMatch['value2']));
        const currentWeek = new Date(currentDay.setDate(currentDay.getDate() - scaleMatch['value2']));
        const estimateDateFormatted = formatDate(findEstimateDate);
        const weekNumber = findWeek.getWeek();
        ...
        if (isNaN(weekNumber) || isNaN(week)) {
        ...
        return {
            estimateDeliveryWeek: `${weekNumber}`,
            estimateDeliveryDate: `${estimateDateFormatted}`,
            currentWeek: `${week}`,
